...
var config = {
    "lang": "th",
    "langFile": "./i18n/language.json"
}
var i18n_module = require('./../../../I18n');
...
module.exports = function () {
	...
	* */
	...
	_helpers.i18n = function (word) {
		return i18n.__(word);
	}

	_helpers.langs = function (lang) {
		console.log(lang + '1');
	...
	// 	return config.lang;
	// }
	// hbs.registerHelper('langs', langs);
